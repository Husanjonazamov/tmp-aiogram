...
def create(project_name):
    ...
    print(f"{project_name} loyihasini yaratish uchun tasdiqlang (y/n): " fg='yellow')
    confirm = input().strip().lower()
    
    if confirm == "y":
        create_folder_structure(project_name)
        print(f"✅ '{project_name}' loyihasi yaratildi!", fg='green')
    else:
        print("❌ Yaratish bekor qilindi.", fg='red')
        sys.exit(0)
